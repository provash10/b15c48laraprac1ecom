                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-primary">
                            ...
                            <!-- /.card-header -->
                            <!-- form start -->
                            {{-- <form action="{{url('/admin/sub-category/update/{id}')}}" method="post" enctype="multipart/form-data"> --}}
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="name" value="{{$subCategory->name}}" id="name" placeholder="Enter Sub-Category Name*" required>
                                    </div>
                                    {{-- no need image --}}
